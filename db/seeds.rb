...
company.users.create({ name: 'example user', email: 'user@email.org', password: '12345678', type: 'user' })
User.create({ name: 'example admin', email: 'admin@unglobalcompact.org', password: '12345678', type: 'admin' })
